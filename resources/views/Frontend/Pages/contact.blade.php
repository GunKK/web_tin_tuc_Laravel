    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="break"></div>
                <h4><i class="fa-duotone fa-building"></i> Địa chỉ : </h4>
                <p>Kí túc xá khu B, Đông Hòa, Dĩ An, Bình Dương </p>

                <h4><i class="fa-light fa-envelope"></i> Email : </h4>
                <p><a href = "mailto: hau.nguyenbk8786@gmail.com">hau.nguyenbk8786@gmail.com</a></p>

                <h4><i class="fa-light fa-phone"></i> Điện thoại : </h4>
                <p><a href="tel:+84 82848xxx">Liên hệ: +84 82848xxx</a> </p>

                <h4><i class="fa-brands fa-github"></i> Github : </h4>
                <p><a href="https://github.com/GunKK">GunKK</a></p>
                <h3><i class="fa-light fa-location-dot"></i> Bản đồ</h3>
